...
public class OfficerRequest implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 347090571634966864L;
	...
	public String toString() {
		...
		builder.append("OfficerRequest [officerId=").append(officerId).append(", hotelId=").append(hotelId)
				.append(", offSalutation=").append(offSalutation).append(", offName=").append(offName)
				.append(", offGrade=").append(offGrade).append(", dtOfJoining=").append(dtOfJoining)
				.append(", offDesignation=").append(offDesignation).append(", offPhoto=").append(offPhoto)
				.append(", offResume=").append(offResume).append(", offComments=").append(offComments)
