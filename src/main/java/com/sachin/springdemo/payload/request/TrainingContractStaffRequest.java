...
public class TrainingContractStaffRequest implements Serializable {
	...
	public String toString() {
		...
		builder.append("TrainingContractStaffRequest [trainingId=").append(trainingId).append(", trainingDt=")
