 ...
 *
 */
public class IncidentDetailsResponse implements Serializable {
	...
	public String toString() {
		...
		builder.append("IncidentDetailsResponse [incidentId=").append(incidentId).append(", status=").append(status)
				...
				.append(", incidentNo=").append(incidentNo).append(", incidentActnTkn=").append(incidentActnTkn)
				.append(", incidentConclusion=").append(incidentConclusion).append(", additional=").append(additional)
				.append("]");
