...
public class ContractStaffResponse implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 685294135307328573L;
	...
	private List<TrainingContractStaffResponse> trainingList;
	...
	public List<TrainingContractStaffResponse> getTrainingList() {
		return trainingList;
	}

	public void setTrainingList(List<TrainingContractStaffResponse> trainingList) {
	...
	public String toString() {
		...
		builder.append("ContractStaffResponse [ticketNo=").append(ticketNo).append(", esicNo=").append(esicNo)
				...
				.append(", hotelId=").append(hotelId).append(", hotelName=").append(hotelName)
				.append(", aadharCardNumber=").append(aadharCardNumber).append(", aadharCardFileName=")
				.append(aadharCardFileName).append("]");
